...
- Búsqueda de señas por palabra.
- Filtro por categorías.
- Visualización progresiva de resultados.
- Descripción textual de cada seña.
- Organización del vocabulario por campos temáticos.
- Diseño adaptable para computadora, tablet y celular.
- Páginas complementarias de créditos, accesibilidad, contacto y preguntas frecuentes.
...
El banco digital presenta vocabulario visual de apoyo. Algunas señas pueden presentar variaciones según la región, la comunidad sorda o el contexto comunicativo. Por ello, la plataforma debe ser usada como referencia educativa y no como fuente normativa única.

La versión actual puede seguir ampliándose con videos demostrativos, fichas descargables, ejemplos de uso, variantes regionales, recursos para docentes y materiales complementarios.

## Estado del proyecto

Versión inicial funcional.

El proyecto se encuentra en proceso de revisión, mejora y ampliación progresiva. Las siguientes etapas pueden incluir:

- Corrección y validación de categorías.
- Incorporación de nuevas señas.
- Elaboración de fichas educativas descargables.
...
Para observaciones, sugerencias o reporte de errores, puede utilizarse la sección de contacto de la aplicación web.
